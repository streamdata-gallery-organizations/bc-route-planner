...
- name: BC Route Planner Get the directions, path, distance and travel time between
  ...
  baseURL: https://router.api.gov.bc.ca////directions.{outputFormat}
  tags: Directions,OutputFormat
  properties:
...
- name: BC Route Planner Get distance and travel time between two geographic points
  ...
  image: ""
  humanURL: https://catalogue.data.gov.bc.ca/dataset/bc-route-planner
  baseURL: https://router.api.gov.bc.ca////distance.{outputFormat}
  tags: Distance,OutputFormat
  properties:
  - type: x-postman-collection
...
- name: BC Route Planner Get distance and travel time between each pair of geographic
  ...
  image: ""
  humanURL: https://catalogue.data.gov.bc.ca/dataset/bc-route-planner
  baseURL: https://router.api.gov.bc.ca////distance/betweenPairs.{outputFormat}
  tags: Distance,BetweenPairs,OutputFormat
  properties:
  - type: x-postman-collection
...
- name: BC Route Planner Get the path, distance and travel time between a series of
    geographic points
  x-api-slug: bc-route-planner
  ...
  image: ""
  humanURL: https://catalogue.data.gov.bc.ca/dataset/bc-route-planner
  baseURL: https://router.api.gov.bc.ca////route.{outputFormat}
  tags: Route,OutputFormat
  properties:
  - type: x-postman-collection
...
- name: BC Route Planner
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/bc-route-planner/master/_listings/bc-route-planner/openapi.md
x-common:
- type: x-website
